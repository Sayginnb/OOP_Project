...
namespace BusinessLayer.ValidationRules
{
    public class TeamValidator : AbstractValidator<Team>
    {
        public TeamValidator()
        {
            ...
            RuleFor(x => x.PersonName).MinimumLength(5).WithMessage("Lütfen en az 5 karakter ver girişi yapınız!");
            RuleFor(x => x.Title).MaximumLength(50).WithMessage("Lütfen en az 50 karakter veri girişi yapınız!");
            RuleFor(x => x.Title).MinimumLength(3).WithMessage("Lütfen en az 3 karakter ver girişi yapınız!");
        }
    }
}
